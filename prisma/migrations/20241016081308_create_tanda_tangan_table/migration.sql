...
-- CreateTable
CREATE TABLE `tanda_tangan_rapat` (
    ...
    UNIQUE INDEX `tanda_tangan_rapat_anggota_rapat_id_key`(`anggota_rapat_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- AddForeignKey
ALTER TABLE `tanda_tangan_rapat` ADD CONSTRAINT `tanda_tangan_rapat_anggota_rapat_id_fkey` FOREIGN KEY (`anggota_rapat_id`) REFERENCES `anggota_rapat`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
