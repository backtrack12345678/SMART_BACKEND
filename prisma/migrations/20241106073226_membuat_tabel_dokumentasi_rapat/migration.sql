...
-- AddForeignKey
ALTER TABLE `dokumentasi_rapat` ADD CONSTRAINT `dokumentasi_rapat_rapat_id_fkey` FOREIGN KEY (`rapat_id`) REFERENCES `rapat`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
